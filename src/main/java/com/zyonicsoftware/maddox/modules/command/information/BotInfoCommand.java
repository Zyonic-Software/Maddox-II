...
public class BotInfoCommand extends Command {
  ...
  protected void execute(final CommandEvent event, final MaddoxMember sender,
    ...
    event.reply(
        new EmbedBuilder()
            .setTitle(this.maddox.getName() + " | Info",
                      "https://github.com/Zyonic-Software/Maddox-V2")
            ...
            .addField(
                "APIs",
                "JDA (by DV8FromTheWorld)\nMysql- & Language-API (by Daschi1)",
                false)
            .setFooter("Maddox by ZyonicSoftware.com",
                       "https://i.ibb.co/Jrn6L5Z/zy-128x128-smaller.png")
