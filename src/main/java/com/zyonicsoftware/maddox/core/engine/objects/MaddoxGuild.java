...
public class MaddoxGuild { // Huge thanks to Spark61 for saving my fingers from
  ...
  public String getID() { return this.guild.getId(); }
  ...
  public ArrayList<String> getRoleIDs() {
    ...
    this.guild.getRoles().forEach(role -> { roleIDs.add(role.getId()); });
    return roleIDs;
  }

  public HashMap<String, Role> getRolesSortedByIDs() {
    final HashMap<String, Role> roleIDs = new HashMap<>();
    this.guild.getRoles().forEach(role -> { roleIDs.put(role.getId(), role); });
    return roleIDs;
  }
  ...
  @Nonnull
  public MemberAction addMember(@Nonnull final String s,
                                @Nonnull final String s1) {
    return this.guild.addMember(s, s1);
  }

  public boolean isLoaded() { return this.guild.isLoaded(); }

  public void pruneMemberCache() { this.guild.pruneMemberCache(); }

  public boolean unloadMember(final long l) {
    return this.guild.unloadMember(l);
  }

  public int getMemberCount() { return this.guild.getMemberCount(); }
  ...
  public int getBoostCount() { return this.guild.getBoostCount(); }
  ...
  public int getMaxMembers() { return this.guild.getMaxMembers(); }

  public int getMaxPresences() { return this.guild.getMaxPresences(); }
  ...
  public long getOwnerIdLong() { return this.guild.getOwnerIdLong(); }
  ...
  public boolean checkVerification() { return this.guild.checkVerification(); }

  public boolean isAvailable() { return this.guild.isAvailable(); }
  ...
  public Task<List<Member>> retrieveMembersByIds(final boolean b,
  ...
  public Task<List<Member>> retrieveMembersByPrefix(@Nonnull final String s,
                                                    final int i) {
    return this.guild.retrieveMembersByPrefix(s, i);
  }

  @Nonnull
  public RestAction<Void>
  moveVoiceMember(@Nonnull final Member member,
                  @Nullable final VoiceChannel voiceChannel) {
  ...
  @Nonnull
  public AuditableRestAction<Void>
  modifyNickname(@Nonnull final Member member,
  ...
  public AuditableRestAction<Integer> prune(final int i, final boolean b,
  ...
  @Nonnull
  public AuditableRestAction<Void> ban(@Nonnull final User user,
                                       final int delDays,
                                       @Nullable final String reason) {
  ...
  @Nonnull
  public AuditableRestAction<Void> ban(@Nonnull final String userId,
                                       final int delDays,
                                       @Nullable final String reason) {
  ...
  @Nonnull
  public AuditableRestAction<Void> ban(@Nonnull final Member member,
                                       final int delDays,
                                       @Nullable final String reason) {
  ...
  public AuditableRestAction<Void> deafen(@Nonnull final Member member,
                                          final boolean b) {
  ...
  public AuditableRestAction<Void> mute(@Nonnull final Member member,
                                        final boolean b) {
    return this.guild.mute(member, b);
  }

  @Nonnull
  public AuditableRestAction<Void> addRoleToMember(@Nonnull final Member member,
                                                   @Nonnull final Role role) {
    return this.guild.addRoleToMember(member, role);
  }

  @Nonnull
  public AuditableRestAction<Void> addRoleToMember(@Nonnull final String userId,
                                                   @Nonnull final Role role) {
  ...
  @Nonnull
  public AuditableRestAction<Void>
  removeRoleFromMember(@Nonnull final Member member, @Nonnull final Role role) {
    return this.guild.removeRoleFromMember(member, role);
  }

  @Nonnull
  public AuditableRestAction<Void>
  removeRoleFromMember(@Nonnull final String userId, @Nonnull final Role role) {
    return this.guild.removeRoleFromMember(userId, role);
  }

  @Nonnull
  public AuditableRestAction<Void>
  modifyMemberRoles(@Nonnull final Member member,
                    @Nullable final Collection<Role> rolesToAdd,
                    @Nullable final Collection<Role> rolesToRemove) {
  ...
  public AuditableRestAction<Void>
  transferOwnership(@Nonnull final Member member) {
    return this.guild.transferOwnership(member);
  }

  @Nonnull
  public ChannelAction<TextChannel>
  createTextChannel(@Nonnull final String name) {
    return this.guild.createTextChannel(name);
  }

  @Nonnull
  public ChannelAction<VoiceChannel>
  createVoiceChannel(@Nonnull final String name) {
  ...
  @Nonnull
  public <T extends GuildChannel> ChannelAction<T>
  createCopyOfChannel(@Nonnull final T channel) {
  ...
  @Nonnull
  public AuditableRestAction<Emote> createEmote(@Nonnull final String name,
  ...
  @Nonnull
  public CategoryOrderAction
  modifyTextChannelPositions(@Nonnull final Category category) {
    return this.guild.modifyTextChannelPositions(category);
  }

  @Nonnull
  public CategoryOrderAction
  modifyVoiceChannelPositions(@Nonnull final Category category) {
  ...
  public long getIDLong() { return this.guild.getIdLong(); }
