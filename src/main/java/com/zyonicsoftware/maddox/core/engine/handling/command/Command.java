...
public abstract class Command {
  ...
  protected void setName(final String name) { this.name = name.toLowerCase(); }
  ...
  public boolean ShowInHelp() { return this.showInHelp; }

  protected void setShowExtendedHelp(final boolean showExtendedHelp) {
    this.showExtendedHelp = showExtendedHelp;
  }

  public boolean isShowExtendedHelp() { return this.showExtendedHelp; }

  protected void setToggleable(final boolean isToggleable) {
    this.toggleable = isToggleable;
  }

  public boolean isToggleable() { return this.toggleable; }

  protected void setCommandHelpViewPermission(
      final CommandHelpViewPermission commandHelpViewPermission) {
  ...
  protected void
  setGetValuesFromLanguageYAML(final boolean getValuesFromLanguage) {
  ...
  protected abstract void execute(CommandEvent event, MaddoxMember sender,
                                  MaddoxGuild server);
}
