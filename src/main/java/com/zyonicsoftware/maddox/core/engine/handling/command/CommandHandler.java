    ...
    if (messageContent.startsWith(prefix + " ")) {
      ...
      if (seperatedStrings.length > 0) {
        ...
        Command selectedCommand =
            commands.get(seperatedStrings[0].toLowerCase());
      ...
      if (seperatedStrings.length > 0) {
        ...
        Command selectedCommand = specificPrefixCommands.get(
      ...
      if (seperatedStrings.length > 0) {
        ...
        Command selectedCommand =
            specificPrefixCommands.get(seperatedStrings[0].toLowerCase());
        if (selectedCommand != null) {
          if (this.maddox.isMySQLConnected()) {
            if (this.maddox.areCommandsToggleable()) {
              if (selectedCommand.isToggleable()) {
