...
public class MaddoxMember {
  ...
  public MaddoxMember(final Member member) { this.member = member; }

  public Member getMember() { return this.member; }

  public User getUser() { return this.member.getUser(); }

  public String getNickame() { return this.member.getNickname(); }

  public String getUsername() { return this.member.getEffectiveName(); }
  ...
  public List<Activity> getActivities() { return this.member.getActivities(); }

  public Color getColor() { return this.member.getColor(); }

  public int getColorRAW() { return this.member.getColorRaw(); }
  ...
  public Guild getCurrentGuild() { return this.member.getGuild(); }

  public JDA getCurrentJDA() { return this.member.getJDA(); }

  public ArrayList<Role> getRoles() {
    return (ArrayList<Role>)this.member.getRoles();
  }

  public OffsetDateTime getTimeJoined() { return this.member.getTimeJoined(); }

  public OffsetDateTime getTimeBoosted() {
    return this.member.getTimeBoosted();
  }

  public boolean hasTimeJoinedValue() { return this.member.hasTimeJoined(); }

  public boolean isGuildOwner() { return this.member.isOwner(); }

  public AuditableRestAction<Void> kick() { return this.member.kick(); }
  ...
  modifyNickname(@Nonnull final String newNickname) {
    return this.member.modifyNickname(newNickname);
  }

  public String getAsMention() { return this.member.getAsMention(); }
  ...
  public EnumSet<Permission>
  getPermissionExplicit(final GuildChannel guildChannel) {
  ...
  public boolean
  hasPermission(@Nonnull final Collection<Permission> permissions) {
    return this.member.hasPermission(permissions);
  }

  public boolean hasPermission(@Nonnull final GuildChannel guildChannel,
                               @Nonnull final Permission... permissions) {
    return this.member.hasPermission(guildChannel, permissions);
  }

  public String getID() { return this.member.getId(); }
  ...
  public CommandHelpViewPermission getCommandHelpViewPermission() {
    ...
    } else if (this.member.getPermissions().contains(
