...
public class StartupLoader {
  ...
  public ShardManager loadShards(final int amountOfShards, final String token,
                                 final ListenerAdapter... listenerAdapters) {
    try {
      return DefaultShardManagerBuilder
          .createLight(
              token, GatewayIntent.GUILD_BANS, GatewayIntent.DIRECT_MESSAGES,
      ...
      System.out.println(
          "The provided token is invalid, please enter a valid one");
      return null;
    }
  }
}
