    ...
    public void initLanguageConfig(Maddox maddox) {
        ...
        try {
            ...
            if (file.createNewFile()) {
                ...
                LanguageAPI.setValue("AutoRole-Response-3", "Nothing was Changed", "EN");
                LanguageAPI.setValue("AutoRole-Response-4", "Please supply the needed arguments: ", "EN");
        ...
        try {
            ...
            if (file.createNewFile()) {
                ...
                LanguageAPI.setValue("AutoRole-Response-3", "Nichts verändert", "DE");
                LanguageAPI.setValue("AutoRole-Response-4", "Bitte gebe die benötigten Argumente an: ", "DE");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
